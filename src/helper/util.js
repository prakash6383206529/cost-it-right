...
import {
  ...
  ELECTRONICS, RIVET, NON_FERROUS_HPDC, RUBBER, NON_FERROUS_GDC, FORGING, FASTNERS, RIVETS, RMDOMESTIC, RMIMPORT, BOPDOMESTIC, BOPIMPORT, COMBINED_PROCESS, OPERATIONS, SURFACETREATMENT, MACHINERATE, OVERHEAD, PROFIT, EXCHNAGERATE, DISPLAY_G, DISPLAY_KG, DISPLAY_MG, VARIANCE, PROCESS, EMPTY_GUID, ZBCTypeId,
...
export function applyEditCondSimulation(master) {
  const ApplyEditCondition = [RMDOMESTIC, RMIMPORT, BOPDOMESTIC, BOPIMPORT, OPERATIONS, SURFACETREATMENT, MACHINERATE, OVERHEAD, PROFIT, COMBINED_PROCESS]
...
export function getOtherCostingSimulation(master) {
  const useOtherSimulationPage = [Number(EXCHNAGERATE), Number(COMBINED_PROCESS)]
