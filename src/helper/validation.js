...
export const checkExtraWhiteSpaces = value => {
...
export const decimalNumberLimit12And12 = (value) => {
    return value && !/^\d{0,12}(\.\d{0,12})?$/i.test(value) ? 'Maximum length for integer is 12 and for decimal is 12' : undefined;
}
