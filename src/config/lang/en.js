export const english = {
    ...
    delete_asset           : "Do you want to delete the asset?",
    seconds                 : "second(s)",
    copyright               : "Copyright @ 2018 Ampcontrol",
    messages : {
        alert_deleted_successfully       : "Alert has been deleted successfully.",
        alert_added_success              : "Alert added successfully.",
        alert_updated_success            : "Alert updated successfully.",
        confirm_delete_Alert             : "Do you want to delete Alert?",
    ...
    validation_messages : {
        ...
        password_pattern                : "Password requires minimum 5 & maximum 25 characters.",
        current_password_required       : "Please enter current password.",
        znew_password_required           : "Please enter new password.",
