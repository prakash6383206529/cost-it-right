...
export const ZBCOperation = [
    ...
    { label: 'MaterialGasCost', value: 'MaterialGasCost' },
    ...
    { label: 'MaterialWireCost', value: 'MaterialWireCost' },
    ...
    { label: 'PowerElectricityCost', value: 'PowerElectricityCost' },
    ...
    { label: 'RejectionAndReworkCost', value: 'RejectionAndReworkCost' },
    { label: 'ProfitCRMHead', value: 'ProfitCRMHead' },
    { label: 'ProfitCRMPercentage', value: 'ProfitCRMPercentage' },
    { label: 'ProfitCRMCost', value: 'ProfitCRMCost' },
...
export const ZBCOperationTempData = [
    ...
    },
    {
        ...
        "RejectionAndReworkCost": "75.00",
        "ProfitCRMHead": "Profit",
        "ProfitCRMPercentage": "10",
        "ProfitCRMCost": "100.00",
...
export const REPORT_DOWNLOAD_EXCEl = [
    ...
    { label: "Net Insert Cost", value: "NetBoughtOutPartCost", },
