...
export const RMDomesticZBC = [
    ...
    { label: "TypeForOtherCost", value: "TypeForOtherCost" },
    { label: "ApplicabilityForOtherCost", value: "ApplicabilityForOtherCost" },
    { label: "PercentageOrCostForOtherCost", value: "PercentageOrCostForOtherCost" },
    { label: "RemarkForOtherCost", value: "RemarkForOtherCost" },
    { label: "CostingCondition", value: "CostingCondition" },
    { label: "TypeForCostingCondition", value: "TypeForCostingCondition" },
...
export const MHRMoreZBC = [
    ...
    { label: "IsSlmForPercentage", value: "IsSlmForPercentage", },
...
export const MHRMoreVBCTempData = [
    {
        "Technology": "Sheet Metal",
        'PlantCode': '8820',
        'VendorCode': '1111',
...
export const MHRMoreCBCTempData = [
    {
        "Technology": "Sheet Metal",
        'PlantCode': '8820',
...
export const VBCInterestRateTempData = [
    {
        ...
        PartFamilyCode: '1234',
        TechnologyName: '',
        ICCModelType: 'All / High Investment / High Volume / Low Volume / Medium Volume',
        ICCMethod: 'Applicability Based / Credit Based',
        InventoryDaysCheckBox: 'YES',
        ApplicabilityBasedInventoryDayType: 'General',
        CreditBasedAnnualICCPercent: '',
...
export const CostingSimulationDownloadRM = [
    ...
    { label: "Gross Weight / Value", value: "RawMaterialGrossWeight" },
    { label: "Vendor (Code)", value: "VendorName" },
    { label: "Plant (Code)", value: "PlantName" },
    { label: "Customer (Code)", value: "CustomerName" },
    { label: "Budgeted Price", value: "BudgetedPrice" },
    { label: "Costing Currency", value: "CostingCurrency" },
    ...
    { label: "Existing Overhead Cost", value: "OldOverheadCost" },
    { label: "Revised Overhead Cost", value: "NewOverheadCost" },
    { label: "Existing Profit Cost", value: "OldProfitCost" },
    { label: "Revised Profit Cost", value: "NewProfitCost" },
    { label: "Existing Rejection Cost", value: "OldRejectionCost" },
    { label: "Revised Rejection Cost", value: "NewRejectionCost" },
    { label: "Existing ICC Cost", value: "OldICCCost" },
    { label: "Revised ICC Cost", value: "NewICCCost" },
    { label: "Existing Payment Terms Cost", value: "OldPaymentTermsCost" },
    { label: "Revised Payment Terms Cost", value: "NewPaymentTermsCost" },
    { label: "Existing Other Cost", value: "OldOtherCost" },
    { label: "Revised Other Cost", value: "NewOtherCost" },
    { label: "Existing Discount Cost", value: "OldDiscountCost" },
    { label: "Revised Discount Cost", value: "NewDiscountCost" },
    { label: "Existing Net Overhead And Profit Cost", value: "OldNetOverheadAndProfitCost" },
    { label: "Revised Net Overhead And Profit Cost", value: "NewNetOverheadAndProfitCost" },
    { label: "Existing Net Tool Cost", value: "OldNetToolCost" },
    { label: "Revised Net Tool Cost", value: "NewNetToolCost" },
    { label: "Existing Net Freight Cost", value: "OldNetFreightCost" },
    { label: "Revised Net Freight Cost", value: "NewNetFreightCost" },
    { label: "Existing Net Packaging Cost", value: "OldNetPackagingCost" },
    { label: "Revised Net Packaging Cost", value: "NewNetPackagingCost" },
    { label: "Existing Net Freight And Packaging Cost", value: "OldNetFreightPackagingCost" },
    { label: "Revised Net Freight And Packaging Cost", value: "NewNetFreightPackagingCost" },
...
export const CostingSimulationDownloadST = [
    ...
    { label: "Existing Surface Treatment Rate", value: "OldSurfaceTreatmentRate" },
    { label: "Revised Surface Treatment Rate", value: "NewSurfaceTreatmentRate" },
    { label: "Existing Surface Treatment Cost", value: "OldSTCost" },
    { label: "Revised Surface Treatment Cost", value: "NewSTCost" },
    { label: "Existing Surface Treatment Cost", value: "OldSurfaceTreatmentCost" },
    { label: "Revised Surface Treatment Cost", value: "NewSurfaceTreatmentCost" },
    { label: "Existing Transpotation Cost", value: "OldTranspotationCost" },
    { label: "Revised Transpotation Cost", value: "NewTranspotationCost" },
    { label: "Existing Net Surface Treatment Cost", value: "OldNetSurfaceTreatmentCost" },
    { label: "Revised Net Surface Treatment Cost", value: "NewNetSurfaceTreatmentCost" },
    ...
    { label: "Existing ICC Cost", value: "OldICCCost" },
    { label: "Revised ICC Cost", value: "NewICCCost" },
    { label: "Existing Payment TermsCost", value: "OldPaymentTermsCost" },
    { label: "Revised Payment Terms Cost", value: "NewPaymentTermsCost" },
    { label: "Existing Other Cost", value: "OldOtherCost" },
    { label: "Revised Other Cost", value: "NewOtherCost" },
    { label: "Existing Discount Cost", value: "OldDiscountCost" },
...
export const CostingSimulationDownloadOperation = [
    ...
    { label: "Existing Operation Rate", value: "OldOperationRate" },
    { label: "Revise dOperation Rate", value: "NewOperationRate" },
    { label: "Operation Variance", value: "OperationVariance" },
    { label: "Existing Operation Cost", value: "OldOperationCost" },
    { label: "Revised Operation Cost", value: "NewOperationCost" },
    { label: "Existing Net Operation Cost", value: "OldNetOperationCost" },
    { label: "Revised Net Operation Cost", value: "NewNetOperationCost" },
...
export const CostingSimulationDownloadBOP = [
    ...
    { label: "Variance (w.r.t. Existing)", value: "Variance" },
    { label: "Variance (w.r.t. Budgeted)", value: "BudgetedPriceVariance" },
    { label: "Existing BOP Rate", value: "OldBOPRate" },
    { label: "Revised BOP Rate", value: "NewBOPRate" },
    { label: "Existing BOP Cost", value: "OldBOPCost" },
    { label: "Revised BOP Cost", value: "NewBOPCost" },
    { label: "Variance (BOP Cost)", value: "BOPVariance" },
    { label: "Existing Net BOP Cost", value: "OldNetBoughtOutPartCost" },
    { label: "Revised Net BOP Cost", value: "NewNetBoughtOutPartCost" },
    { label: "NetBOP Cost Variance", value: "NetBoughtOutPartCostVariance" },
    { label: "Existing Exchange Rate", value: "OldExchangeRate" },
    { label: "Revised Exchange Rate", value: "NewExchangeRate" },
    { label: "Variance (w.r.t. Existing)", value: "ERVariance" },
    { label: "Impact/Quarter (w.r.t. Existing)", value: "ImpactPerQuarter" },
...
export const CostingSimulationDownloadMR = [
    ...
    { label: "Existing Process Cost", value: "OldProcessCost" },
    { label: "Revised Process Cost", value: "NewProcessCost" },
    ...
    { label: "Existing Other Cost", value: "OldOtherCost" },
    { label: "Revised Other Cost", value: "NewOtherCost" },
    { label: "Existing Discoun tCost", value: "OldDiscountCost" },
    { label: "Revised Discount Cost", value: "NewDiscountCost" },
    { label: "Existing Net Overhead And Profit Cost", value: "OldNetOverheadAndProfitCost" },
    { label: "Revised Net Overhead And Profit Cost", value: "NewNetOverheadAndProfitCost" },
    { label: "Existing Net Tool Cost", value: "OldNetToolCost" },
...
export const applicabilityList = [
    { label: 'RM With Parts', value: 'RM With Parts' },
    { label: "RM", value: "RM" },
    { label: 'BOP With Parts', value: 'BOP With Parts' },
    { label: 'BOP', value: 'BOP' },
...
export const APPLICABILITY_RM_SIMULATION = "RM With Parts"
export const APPLICABILITY_BOP_SIMULATION = "BOP With Parts"
export const APPLICABILITY_BOP_NON_ASSOCIATED_SIMULATION = "BOP"
...
export const APPLICABILITY_RAWMATERIAL_SIMULATION = "RM"
