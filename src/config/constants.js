...
export const API = {
  ...
  getSimulationRmCorrugatedBoxCalculation: `${BASE_URL}/simulation/get-simulation-raw-material-corrugated-box-calculation-details`,
...
//VERSION 
export const VERSION = "V2.1.260.9";
