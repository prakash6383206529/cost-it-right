...
export const API = {
  ...
  checkHistoryCostingAndSAPPoPrice: `${BASE_URL}/sap-integration/check-history-costing-and-sap-po-price`,
  ...
  bulkUploadVolumeActual: `${BASE_URL}/masters-volume/bulk-upload-for-actual-volume-json`,
  bulkUploadVolumeBudgeted: `${BASE_URL}/masters-volume/bulk-upload-for-budgeted-volume-json`,
  ...
  getAmmendentStatus: `${BASE_URL}/sap-integration/get-ammendent-status`,
...
export const FORGING = 'Forging & Machining';
...
export const COMBINED_PROCESS = '3'
