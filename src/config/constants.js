...
export const GET_TECHNOLOGY_SELECTLIST_SUCCESS =
...
export const GET_UNASSOCIATED_VENDOR_PLANT_SELECTLIST =
...
export const GET_CATEGORY_MASTER_DATA_SUCCESS =
...
export const GET_LABOUR_TYPE_SELECTLIST_SUCCESS =
...
export const GET_UNIT_TYPE_SELECTLIST_SUCCESS =
...
export const GET_RAW_MATERIAL_DETAILS_DATA_SUCCESS =
  'GET_RAW_MATERIAL_DETAILS_DATA_SUCCESS'
export const GET_RAW_MATERIAL_DETAILS_UNIT_DATA_SUCCESS =
...
export const GET_GRADELIST_BY_RM_NAME_SELECTLIST =
  'GET_GRADELIST_BY_RM_NAME_SELECTLIST'
export const GET_VENDORLIST_BY_VENDORTYPE_SELECTLIST =
  'GET_VENDORLIST_BY_VENDORTYPE_SELECTLIST'
export const GET_RAW_MATERIAL_FILTER_DYNAMIC_DATA =
  'GET_RAW_MATERIAL_FILTER_DYNAMIC_DATA'
export const GET_GRADE_FILTER_BY_RAW_MATERIAL_SELECTLIST =
  'GET_GRADE_FILTER_BY_RAW_MATERIAL_SELECTLIST'
export const GET_VENDOR_FILTER_BY_RAW_MATERIAL_SELECTLIST =
  'GET_VENDOR_FILTER_BY_RAW_MATERIAL_SELECTLIST'
export const GET_RAW_MATERIAL_FILTER_BY_GRADE_SELECTLIST =
  'GET_RAW_MATERIAL_FILTER_BY_GRADE_SELECTLIST'
export const GET_VENDOR_FILTER_BY_GRADE_SELECTLIST =
  'GET_VENDOR_FILTER_BY_GRADE_SELECTLIST'
export const GET_RAWMATERIAL_FILTER_BY_VENDOR_SELECTLIST =
  'GET_RAWMATERIAL_FILTER_BY_VENDOR_SELECTLIST'
export const GET_GRADE_FILTER_BY_VENDOR_SELECTLIST =
...
//RM SPECIFICATION
export const GET_RM_SPECIFICATION_LIST_SUCCESS =
...
export const GET_GRADE_BY_RMTYPE_SELECTLIST_SUCCESS =
  'GET_GRADE_BY_RMTYPE_SELECTLIST_SUCCESS'
export const GET_GRADE_SELECTLIST_BY_RAWMATERIAL =
...
export const GET_VENDOR_TYPE_SELECTLIST_SUCCESS =
  'GET_VENDOR_TYPE_SELECTLIST_SUCCESS'
export const GET_ALL_VENDOR_SELECTLIST_SUCCESS =
  'GET_ALL_VENDOR_SELECTLIST_SUCCESS'
export const GET_VENDOR_TYPE_SELECTLIST_BY_VENDOR =
  'GET_VENDOR_TYPE_SELECTLIST_BY_VENDOR'
export const GET_VENDOR_WITH_VENDOR_CODE_SELECTLIST =
...
export const GET_BOM_UNIT_DATA_BY_PART_SUCCESS =
  'GET_BOM_UNIT_DATA_BY_PART_SUCCESS'
export const GET_ASSEMBLY_PART_DATALIST_SUCCESS =
...
export const GET_BOP_CATEGORY_SELECTLIST_SUCCESS =
...
export const GET_INITIAL_PLANT_SELECTLIST_SUCCESS =
...
export const GET_INITIAL_MACHINE_TYPE_SELECTLIST =
  'GET_INITIAL_MACHINE_TYPE_SELECTLIST'
export const GET_INITIAL_MACHINE_LIST_SUCCESS =
  'GET_INITIAL_MACHINE_LIST_SUCCESS'
export const GET_INITIAL_PROCESSES_LIST_SUCCESS =
...
export const GET_UNIT_OTHER_OPERATION_DATA_SUCCESS =
...
export const GET_SOURCE_PLANTS_BY_SOURCE_CITY =
  'GET_SOURCE_PLANTS_BY_SOURCE_CITY'
export const GET_DESTINATION_PLANTS_BY_DESTINATION_CITY =
...
export const GET_OPERATION_SELECTLIST_SUCCESS =
  'GET_OPERATION_SELECTLIST_SUCCESS'
export const GET_INITIAL_VENDOR_WITH_VENDOR_CODE_SELECTLIST =
  'GET_INITIAL_VENDOR_WITH_VENDOR_CODE_SELECTLIST'
export const GET_INITIAL_TECHNOLOGY_SELECTLIST =
...
export const GET_FREIGHT_FULL_TRUCK_CAPACITY_SELECTLIST =
  'GET_FREIGHT_FULL_TRUCK_CAPACITY_SELECTLIST'
export const GET_FREIGHT_RATE_CRITERIA_SELECTLIST =
  'GET_FREIGHT_RATE_CRITERIA_SELECTLIST'

//ADDITIONAL FREIGHT MASTER
export const GET_ALL_ADDITIONAL_FREIGHT_SUCCESS =
  'GET_ALL_ADDITIONAL_FREIGHT_SUCCESS'
export const GET_ADDITIONAL_FREIGHT_DATA_SUCCESS =
  'GET_ADDITIONAL_FREIGHT_DATA_SUCCESS'
export const GET_ADDITIONAL_FREIGHT_BY_SUPPLIER_SUCCESS =
...
export const GET_LABOUR_TYPE_BY_PLANT_SELECTLIST =
  'GET_LABOUR_TYPE_BY_PLANT_SELECTLIST'
export const GET_LABOUR_TYPE_BY_MACHINE_TYPE_SELECTLIST =
  'GET_LABOUR_TYPE_BY_MACHINE_TYPE_SELECTLIST'

//OVERHEAD AND PROFIT
export const GET_OVERHEAD_PROFIT_SUCCESS = 'GET_OVERHEAD_PROFIT_SUCCESS'
export const GET_OVERHEAD_PROFIT_COMBO_DATA_SUCCESS =
  'GET_OVERHEAD_PROFIT_COMBO_DATA_SUCCESS'
export const GET_OVERHEAD_PROFIT_DATA_SUCCESS =
  'GET_OVERHEAD_PROFIT_DATA_SUCCESS'
export const GET_MODEL_TYPE_SELECTLIST = 'GET_MODEL_TYPE_SELECTLIST'
export const GET_VENDOR_FILTER_WITH_VENDOR_CODE_SELECTLIST =
  'GET_VENDOR_FILTER_WITH_VENDOR_CODE_SELECTLIST'
export const GET_VENDOR_FILTER_BY_MODELTYPE_SELECTLIST =
  'GET_VENDOR_FILTER_BY_MODELTYPE_SELECTLIST'
export const GET_MODELTYPE_FILTER_BY_VENDOR_SELECTLIST =
...
export const GET_INTEREST_RATE_COMBO_DATA_SUCCESS =
  'GET_INTEREST_RATE_COMBO_DATA_SUCCESS'
export const GET_INTEREST_RATE_DATA_SUCCESS = 'GET_INTEREST_RATE_DATA_SUCCESS'
export const GET_PAYMENT_TERMS_APPLICABILITY_SELECTLIST =
  'GET_PAYMENT_TERMS_APPLICABILITY_SELECTLIST'
export const GET_ICC_APPLICABILITY_SELECTLIST =
  'GET_ICC_APPLICABILITY_SELECTLIST'

//COSTING
export const GET_COSTING_TECHNOLOGY_SELECTLIST =
...
export const GET_SUPPLIER_DETAIL_BY_PARTID_SUCCESS =
  'GET_SUPPLIER_DETAIL_BY_PARTID_SUCCESS'
export const CREATE_PART_WITH_SUPPLIER_SUCCESS =
  'CREATE_PART_WITH_SUPPLIER_SUCCESS'
export const CREATE_SHEETMETAL_COSTING_SUCCESS =
...
export const GET_ZBC_COSTING_SELECTLIST_BY_PART =
...
export const GET_COSTING_DETAILS_BY_COSTING_ID =
...
export const GET_COSTING_BY_VENDOR_VENDOR_PLANT =
...
export const CREATE_WEIGHT_CALC_COSTING_SUCCESS =
...
export const ADD_RAW_MATERIAL_COSTING_SUCCESS =
...
export const GET_OTHER_OPERATION_LIST_SUCCESS =
  'GET_OTHER_OPERATION_LIST_SUCCESS'
export const ADD_OTHER_OPERATION_COSTING_SUCCESS =
  'ADD_OTHER_OPERATION_COSTING_SUCCESS'
export const ADD_UNIT_OTHER_OPERATION_COSTING_DATA =
...
export const GET_OTHER_OPERATION_SELECT_LIST_SUCCESS =
  'GET_OTHER_OPERATION_SELECT_LIST_SUCCESS'
export const SAVE_OTHER_OPERATION_COSTING_SUCCESS =
  'SAVE_OTHER_OPERATION_COSTING_SUCCESS'
export const ADD_PROCESS_COSTING_SUCCESS = 'ADD_PROCESS_COSTING_SUCCESS'
export const GET_MATERIAL_DATA_SELECTLIST_SUCCESS =
  'GET_MATERIAL_DATA_SELECTLIST_SUCCESS'
export const GET_COST_SUMMARY_OTHER_OPERATION_LIST_SUCCESS =
  'GET_COST_SUMMARY_OTHER_OPERATION_LIST_SUCCESS'
export const SET_CED_ROW_DATA_TO_COST_SUMMARY =
  'SET_CED_ROW_DATA_TO_COST_SUMMARY'
export const SET_FREIGHT_ROW_DATA_TO_COST_SUMMARY =
  'SET_FREIGHT_ROW_DATA_TO_COST_SUMMARY'
export const SET_COSTING_DETAIL_ROW_DATA = 'SET_COSTING_DETAIL_ROW_DATA'
export const SET_INVENTORY_ROW_DATA_TO_COST_SUMMARY =
  'SET_INVENTORY_ROW_DATA_TO_COST_SUMMARY'
export const UPDATE_COSTING_OTHER_OPERATION_SUCCESS =
...
export const GET_ALL_APPROVAL_USERS_BY_DEPARTMENT =
  'GET_ALL_APPROVAL_USERS_BY_DEPARTMENT'
export const GET_ALL_APPROVAL_USERS_FILTER_BY_DEPARTMENT =
...
export const GET_DEPRECIATION_SELECTLIST_SUCCESS =
  'GET_DEPRECIATION_SELECTLIST_SUCCESS'

//POWER MASTER
export const GET_POWER_TYPE_SELECTLIST_SUCCESS =
  'GET_POWER_TYPE_SELECTLIST_SUCCESS'
export const GET_CHARGE_TYPE_SELECTLIST_SUCCESS =
  'GET_CHARGE_TYPE_SELECTLIST_SUCCESS'
export const GET_POWER_SUPPLIER_TYPE_SELECTLIST_SUCCESS =
...
export const GET_VOLUME_DATA_BY_PART_AND_YEAR =
