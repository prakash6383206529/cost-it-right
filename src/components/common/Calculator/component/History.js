...
function addScrollbarIfNeeded(element) {
  if (element && isOverflowedY(element)) element.style.overflowY = "scroll";
  else if (element) element.style.overflowY = "initial";

  if (element && isOverflowedX(element)) element.style.overflowX = "scroll";
  else if (element) element.style.overflowX = "initial";
}
