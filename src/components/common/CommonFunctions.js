...
export const OperationFileData = (fileData) => {
    fileData.forEach(obj => {
        if (obj.ForType === 'Welding') {
        ...
        } else if (obj.ForType === 'Ni Cr Plating') {
            ...
            delete obj['MaterialGasRate/NiScrapRate'];
            delete obj['MaterialGasConsumption/NiScrapRateConsumption'];
        } else if (obj.ForType === 'Welding' || obj.ForType === 'Ni Cr Plating') {
        ...
        } else if (obj.ForType === 'Surface Treatment' || obj.ForType === 'Other Operation') {
