...
const TooltipCustom = (props) => {
    const { tooltipText,customClass, tooltipClass } = props;
    ...
    return (
        <>
            ...
            <Tooltip className={tooltipClass} placement="top" isOpen={tooltipOpen} target={`A_${nu_id}_A`} toggle={toggle}>{tooltipText}</Tooltip>
        </>
    );
}
