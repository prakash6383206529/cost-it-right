...
import { Row, Col, Tooltip, FormGroup, Label, Input } from "reactstrap";
import {
...
function AddAuction(props) {
  ...
  const [selectedPriceZoneType, setSelectedPriceZoneType] =
    useState("priceZone%");
  ...
  const [comparsionAuction, setComparsionAuction] = useState(false);
  const [comparsionData, setComparsionData] = useState({});
  ...
  const handleRadioPriceChange = (e) => {
    setSelectedPriceZoneType(e.target.value);
  };
  useEffect(() => {
    setSelectedType("%");
    setSelectedPriceZoneType("priceZone%");
  }, []);
                      ...
                      <Row className="part-detail-wrapper">
                        <Col md="3">
                          <AsyncSearchableSelectHookForm
                            ...
                            asyncOptions={(inputValue) =>
                              partFilterList(inputValue, partTypeforRM)
                            }
                            NoOptionMessage={
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(plant).length !== 0 ? plant : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(rmName).length !== 0 ? rmName : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(rmgrade).length !== 0 ? rmgrade : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(rmspecification).length !== 0
                                ? rmspecification
                                : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(rmCode).length !== 0 ? rmCode : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(bopNumber).length !== 0
                                ? bopNumber
                                : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(bopName).length !== 0 ? bopName : ""
                            }
                        ...
                        <Col md="3">
                          <SearchableSelectHookForm
                            ...
                            register={register}
                            defaultValue={
                              Object.keys(bopCategory).length !== 0
                                ? bopCategory
                                : ""
                            }
                                ...
                                >
                                  <Label check>
                                    <Input
                                      ...
                                      checked={
                                        selectedPriceZoneType === option.value
                                      }
                                    />{" "}
                                    {option.label}
                                  </Label>
                            ...
                            {selectedPriceZoneType === "priceZone%" ? (
                              <>
                                <TextFieldHookForm
                                  ...
                                  placeholder={"Reduction Price %"}
                                  disabled={
                                    selectedPriceZoneType === "priceZonevalue"
                                  }
                                />
