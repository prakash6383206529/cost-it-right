...
import {
  ...
  DASHBOARDWITHGRAPH_PATH, SIMULATION_APPROVAL_SUMMARY_PATH, DASHBOARD_PATH, DASHBOARD_PATH_SECOND, SHEET_METAL, SIMULATION_PATH, SIMULATION_HISTORY_PATH, USER_PATH, RFQ_LISTING, RFQ, COST_RATIO_REPORT, BUDGETING, NFR_LISTING, NFR, MASTER_BENCHMARK_REPORT, COST_MOVEMENT_REPORT, SUPPLIER_CONTRIBUTION_REPORT, SALE_PROVISION_REPORT, PURCHASE_PROVISION_REPORT, CUSTOMER_POAM_REPORT, HEAD_WISE_COSTING_GOT_GIVEN, PLANT_HEAD_WISE, PRODUCT_ROLLOUT, OUTSOURCING, COSTING_DETAIL, MASTER_COST_MOVEMENT_REPORT, RESET_PASSWORD, FORGET_PASSWORD, SAP_PUSH_DETAIL
  ...
  render() {
    ...
    const fullSizeClass =
      location.pathname === COSTING_PATH ||
        ...
        location.pathname === SAP_PUSH_DETAIL ? 'w-100' : ''
          ...
          <div className={isLogin ? 'blue-box' : ''}>
            <div className={isLogin ? 'main-section' : ''}>
              {isLogin &&
                ...
                location.pathname !== RFQ_LISTING &&
                location.pathname !== NFR_LISTING &&
                location.pathname !== SAP_PUSH_DETAIL &&
                (
                  <LeftMenu {...this.props} />
                )}
