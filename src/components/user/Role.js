					...
					<div className="row">
						<div className="col-md-12 my-3" >
							<button
								type="button"
								className={'user-btn'}
								onClick={() => this.setState({ isShowForm: !this.state.isShowForm })}><div className={'plus'}></div> ADD ROLE</button>
						</div>
								...
								<div className="shadow-lgg login-formg ">
									...
									<form onSubmit={handleSubmit(this.onSubmit.bind(this))} noValidate>
										<div className="row form-group role-form">
											<div className="col-md-2" style={{ maxWidth: "12.5%" }}>
                                    ...
                                    {this.renderModule()}
										...
										<div className=" row form-group grant-user-grid role-user-grid mt-30">
											<div className="col-md-12">
										...
										<div className="text-right btn-block-bg mb-30">
											{isEditFlag &&
												<input
													...
													type="button"
													value="Cancel"
													className="reset mr10 cancel-btn"
												/>}
											{!isEditFlag &&
												<input
													disabled={pristine || submitting}
											...
											<input
												...
												className="submit-button mr0 save-btn"
											/>
