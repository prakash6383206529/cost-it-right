...
class LevelTechnologyListing extends Component {
	...
	*/
	...
	buttonFormatter = (props) => {
		...
		return (
			<>
				{EditAccessibility && <button tilte="Edit" type={'button'} className="Edit " onClick={() => this.editItemDetails(cellValue, 'Costing')} />}
	...
	*/
	simulationButtonFormatter = (props) => {
		...
		return (
			<>
				{EditAccessibility && <button tilte="Edit" type={'button'} className="Edit " onClick={() => this.editItemDetails(cellValue, 'Simulation')} />}
				{/* {DeleteAccessibility && <button type={'button'} className="Delete" onClick={() => this.deleteItem(cell)} />} */}
			</>
		)
	}
	...
	*/
	masterButtonFormatter = (props) => {
		...
		return (
			<>
				{EditAccessibility && <button tilte={"Edit"} type={'button'} className="Edit " onClick={() => this.editItemDetails(cellValue, 'Master')} />}
				{/* {DeleteAccessibility && <button type={'button'} className="Delete" onClick={() => this.deleteItem(cell)} />} */}
			</>
		)
	}
