                                ...
                                <div className={`ag-grid-wrapper height-width-wrapper reset-btn-container ${(list && list?.length <= 0) || noData ? "overlay-contain" : ""}`}>
                                    ...
                                    <div className="ag-theme-material p-relative" style={{ width: '100%' }}>
                                        ...
                                        >
                                            ...
                                            <AgGridColumn headerClass="justify-content-center" cellClass="text-center" width={240} headerName={`${(Number(selectedMasterForSimulation?.value) === Number(RMIMPORT) || Number(selectedMasterForSimulation?.value) === Number(EXCHNAGERATE) || String(props?.masterId) === String(RMIMPORT))} ? "Basic Rate (Currency)" : "Basic Rate (${reactLocalStorage.getObject("baseCurrency")})"`} marryChildren={true} >
                                            ...
                                            <AgGridColumn headerClass="justify-content-center" cellClass="text-center" width={240} marryChildren={true} headerName={`${(Number(selectedMasterForSimulation?.value) === Number(RMIMPORT) || Number(selectedMasterForSimulation?.value) === Number(EXCHNAGERATE) || String(props?.masterId) === String(RMIMPORT))} ? "Scrap Rate (Currency)" : "Scrap Rate (${reactLocalStorage.getObject("baseCurrency")})"`}>
                                            ...
                                            {<AgGridColumn headerClass="justify-content-center" cellClass="text-center" width={240} headerName={`${(Number(selectedMasterForSimulation?.value) === Number(RMIMPORT) || Number(selectedMasterForSimulation?.value) === Number(EXCHNAGERATE) || String(props?.masterId) === String(RMIMPORT))} ? "Net Cost (Currency)" : "Net Cost (${reactLocalStorage.getObject("baseCurrency")})"`}>
