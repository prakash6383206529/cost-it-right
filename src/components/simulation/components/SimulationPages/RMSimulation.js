                                ...
                                <div className={`ag-grid-wrapper height-width-wrapper reset-btn-container ${(list && list?.length <= 0) || noData ? "overlay-contain" : ""}`}>
                                    ...
                                    <div className="ag-theme-material p-relative" style={{ width: '100%' }}>
                                        ...
                                        >
                                            ...
                                            <AgGridColumn width={140} field="EffectiveDate" editable='false' cellRenderer={'effectiveDateFormatter'} headerName={props.isImpactedMaster ? "Current RM Effective date" : "Effective Date"} ></AgGridColumn>
