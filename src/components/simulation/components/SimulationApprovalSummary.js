                                    ...
                                    <Row>
                                        <Col md="12">
                                            <Table responsive className="table cr-brdr-main" size="sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td> {approvalDetails && approvalDetails.CostingId ? approvalDetails.CostingId : '-'}                    </td>
                                                        <td>{approvalDetails && approvalDetails.CostingHead ? approvalDetails.CostingHead : '-'}                    </td>

                                                        <td> {approvalDetails && approvalDetails.VendorName ? approvalDetails.VendorName : '-'}</td>
                                                        <td> {approvalDetails && approvalDetails.Technology ? approvalDetails.Technology : '-'} </td>
                                                        <td>{approvalDetails && approvalDetails.PartNo !== null ? approvalDetails.PartNo : '-'}</td>
                                                        <td>{approvalDetails && approvalDetails.PartDescription !== null ? approvalDetails.PartDescription : '-'}</td>
                                                        <td>{approvalDetails && approvalDetails.ECNNumber !== null ? approvalDetails.ECNNumber : '-'}                    </td>
                                                        <td>{approvalDetails && approvalDetails.DrawingNo !== null ? approvalDetails.DrawingNo : '-'}                    </td>
                                                        <td>{approvalDetails && approvalDetails.RevisionNo !== null ? approvalDetails.RevisionNo : '-'}                    </td>
                                                        <td>{approvalDetails && approvalDetails.OldPOPrice !== null ? approvalDetails.OldPOPrice : '-'}                                                </td>
                                                        <td>{approvalDetails && approvalDetails.NewPOPrice !== null ? approvalDetails.NewPOPrice : '-'}                                                </td>
                                                        <td>
                                                            {approvalDetails && approvalDetails.RMOldCost !== null ? approvalDetails.RMOldCost : '-'}
                                                        </td>
                                                        <td>
                                                            {approvalDetails && approvalDetails.RMNewCost !== null ? approvalDetails.RMNewCost : '-'}
                                                        </td>
                                                        <td></td>
                                                    </tr>
