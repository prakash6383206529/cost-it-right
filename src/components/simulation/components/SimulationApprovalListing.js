...
import { getSimulationApprovalList, setMasterForSimulation, deleteDraftSimulation, setSelectedRowForPagination, setTechnologyForSimulation, setBOPAssociation } from '../actions/Simulation'
...
function SimulationApprovalListing(props) {
    ...
    */
    ...
    const viewDetails = (rowObj) => {
        dispatch(setBOPAssociation(!rowObj?.IsSimulationWithOutCosting))
