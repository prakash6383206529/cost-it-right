...
function HeadWiseCostingGotGiven(props) {
    ...
    return (<>
        ...
        {!reportListing && <div className="container-fluid ag-grid-react">
            ...
            <CostReportForm isDateMandatory={true} isDataClear={isDataClear} isPlantRequired={true} showVendor={true} hideAddtable={true} dateHide={true} partWithRevision={true} />
