...
function SaleProvisionListing(props) {
    ...
    useEffect(() => {
        ...
        tableData && tableData.map((item) => {
            sampleArray.push({ PartId: item.PartId, PlantId: item.PlantId, VendorId: null, TechnologyId: item.TechnologyId, CustomerId: item.CustomerId })
        })
            ...
            if (res?.data?.Result) {
                ...
                Data.map((item, index) => {
                    item.costingInfo.map((ele, ind) => {
                        ...
                        obj.purchaseDocumentNumber = item.BillingNumber
                                    ...
                                    <div className="ag-grid-wrapper height-width-wrapper">
                                        ...
                                        <div className="ag-theme-material">
                                            ...
                                            >
                                                ...
                                                {/* {<AgGridColumn field="PlantCode" width="120" headerName="Plant Code" cellRenderer={hyphenFormatter} floatingFilter={true}></AgGridColumn>} */}
                                                ...
                                                {<AgGridColumn field="purchaseDocumentNumber" width="120" headerName="Purch.Doc." cellRenderer={hyphenFormatter} floatingFilter={true}></AgGridColumn>}
...
export default SaleProvisionListing;