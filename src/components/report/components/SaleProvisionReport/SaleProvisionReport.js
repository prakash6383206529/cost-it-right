...
import SaleProvisionListing from "./SaleProvisionListing"
    ...
    */
    ...
    return (
        <>
            ...
            {saleProvisionListing && <SaleProvisionListing hideListing={saleProvisionListing} closeDrawer={closeDrawer} />}
        </>
    )
}
