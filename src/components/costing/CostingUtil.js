...
export const formatMultiTechnologyUpdate = (tabData, totalCost = 0, surfaceTabData = {}, overHeadAndProfitTabData = {}, packageAndFreightTabData = {}, toolTabData = {}, DiscountCostData = {}) => {
  ...
  let temp = {
    ...
    "TopRow": {
      ...
      "NetToolCost": toolTabData?.CostingPartDetails?.NetToolCost,
      "NetOtherCost": DiscountCostData?.CostingPartDetails?.NetOtherCost,
      "NetDiscounts": DiscountCostData?.CostingPartDetails?.NetDiscounts,
