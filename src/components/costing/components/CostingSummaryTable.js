                      ...
                      <tr className="main-row">
                        ...
                        {viewCostingData &&
                          viewCostingData?.map((data, index) => {
                            ...
                            return (
                              <th scope="col" className={`${props?.isRfqCosting && data.isRFQFinalApprovedCosting && !data?.bestCost ? 'finalize-cost' : ''} header-name ${isLockedState && data?.status !== DRAFT && costingSummaryMainPage && !pdfHead && !drawerDetailPDF ? 'pt-30' : ''}`}>
                    ...
                    <tbody>
                        ...
                        (!isApproval || approvalMode) ?
                          <tr>
                            ...
                            {viewCostingData &&
                              viewCostingData?.map((data, index) => {
                                return (
                                  <td className={props?.isRfqCosting && data.isRFQFinalApprovedCosting && !data?.bestCost ? 'finalize-cost' : ''}>
                      ...
                      {!isLogisticsTechnology ? <>
                          ...
                          <>
                            ...
                            <tr className={`background-light-blue  ${isApproval && !props.isRfqCosting ? viewCostingData?.length > 0 && viewCostingData[0]?.netRM > viewCostingData[1]?.netRM ? 'green-row' : viewCostingData[0]?.netRM < viewCostingData[1]?.netRM ? 'red-row' : '' : '-'}`}>
                              ...
                              {viewCostingData &&
                                viewCostingData?.map((data, index) => {
                                  return (
                                    <td className={props?.isRfqCosting && data.isRFQFinalApprovedCosting && !isApproval && !data?.bestCost ? 'finalize-cost' : ''}>
                                      {data?.CostingHeading === VARIANCE && (isApproval ? viewCostingData?.length > 0 && viewCostingData[0]?.netRM > viewCostingData[1]?.netRM ? <span className='positive-sign'>+</span> : '' : '')}
                        ...
                        {!drawerDetailPDF ? <tr>
                          ...
                          {viewCostingData &&
                            viewCostingData?.map((data) => {
                              return (
                                <td className={`${props?.isRfqCosting && data.isRFQFinalApprovedCosting && !data?.bestCost ? 'finalize-cost' : ''} ${pdfHead || drawerDetailPDF ? '' : ''}`}>
                                  <div className={`d-flex`}>
                        ...
                        <tr className='border-right'>
                          ...
                          {viewCostingData &&
                            viewCostingData?.map((data) => {
                              return (
                                (data?.bestCost !== true) && data?.CostingHeading !== VARIANCE ?
                                  <td className={props?.isRfqCosting && data.isRFQFinalApprovedCosting && !data?.bestCost ? 'finalize-cost' : ''} width={"32%"}>
...

                      {
                        ...
                        <tr className={`background-light-blue netPo-row ${!props?.isRfqCosting && isApproval && !props.isRfqCosting ? viewCostingData?.length > 0 && viewCostingData[0]?.nPOPrice > viewCostingData[1]?.nPOPrice ? 'green-row' : viewCostingData[0]?.nPOPrice < viewCostingData[1]?.nPOPrice ? 'red-row' : '' : '-'}`}>
                          ...
                          {viewCostingData &&
                            viewCostingData?.map((data, index) => {
                              return <td className={props?.isRfqCosting && data.isRFQFinalApprovedCosting && !isApproval && !data?.bestCost ? 'finalize-cost' : ''}>
                      ...
                      {viewCostingData[0]?.technologyId !== LOGISTICS &&
                        ...
                        viewCostingData?.map((data, index) => {
                          ...
                          {viewCostingData &&
                            viewCostingData?.map((data, index) => {
                              return <td className={props?.isRfqCosting && data.isRFQFinalApprovedCosting && !isApproval && !data?.bestCost ? 'finalize-cost' : ''}> {data?.CostingHeading === VARIANCE && (isApproval ? viewCostingData?.length > 0 && viewCostingData[0]?.nPOPriceWithCurrency > viewCostingData[1]?.nPOPriceWithCurrency ? <span className='positive-sign'>+</span> : '' : '')}
                      ...
                      {viewCostingData[0]?.technologyId !== LOGISTICS && <tr>
                        ...
                        {viewCostingData &&
                          viewCostingData?.map((data, index) => {
                            return <td className={props?.isRfqCosting && data.isRFQFinalApprovedCosting && !data?.bestCost ? 'finalize-cost' : ''}><span className="d-block small-grey-text">{(data?.bestCost === true) ? ' ' : (data?.CostingHeading !== VARIANCE ? data?.remark : '')}</span></td>
                          })}
                      </tr>}
