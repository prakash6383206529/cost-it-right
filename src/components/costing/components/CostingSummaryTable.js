                    ...
                    <tr class="background-light-blue">
                      ...
                      {viewCostingData &&
                        viewCostingData.map((data, index) => {
                          return (
                            <td>
                              <span>{data.CostingHeading !== VARIANCE ? checkForDecimalAndNull(data.nSurfaceTCost, initialConfiguration.NoOfDecimalForPrice) : checkForDecimalAndNull(data.nConvCost, initialConfiguration.NoOfDecimalForPrice)}</span>
                              {
                                (data.CostingHeading !== VARIANCE && icons )  &&
                                <button
                                  type="button"
