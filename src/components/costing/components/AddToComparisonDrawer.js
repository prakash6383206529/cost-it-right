...
function AddToComparisonDrawer(props) {
   ...
   console.log(partNo,"Summary part no");
    ...
    useEffect(() => {
      ...
      setisCbcSelected(false)
      vendorSelectList && vendorSelectList.map( vendor => {
  ...
  const handleComparison = ( value ) => {
        ...
        if(value === "ZBC") {
          ...
          dispatch(getClientSelectList((res) => {
              ...
              res.data.SelectList && res.data.SelectList.map( client =>{
  ...
  const handlePlantChange = (value) => {
    ...
    dispatch(getCostingSummaryByplantIdPartNo(partNo.label,value.value,(res) => {
          console.log(res.data.Data.CostingOptions,"Response from summary");
          res.data.Data.CostingOptions && res.data.Data.CostingOptions.map( costing =>{
            temp.push({ label:costing.CostingNumber, value: costing.CostingId})
          })
             ...
             >
              <Row>
                ...
                <Col md="12">
                    ...
                    rules={{ required: true }}
                    register={register}
                    defaultValue={costingDropdown.length !== 0 ? costingDropdown : ''}
