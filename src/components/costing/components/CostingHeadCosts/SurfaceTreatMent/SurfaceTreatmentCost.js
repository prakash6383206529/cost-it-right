                      ...
                      return (
                        editIndex === index ?
                          <tr key={index}>
                            ...
                            <td className='text-overflow'><span title={item.OperationName + index} draggable={(CostingViewMode || isDisable) ? false : true}>{item.OperationName}</span> </td>
                            <td style={{ width: 200 }}>
                              {
                                <TextFieldHookForm
                                  label={false}
                            ...
                            <td>
                              <div className='action-btn-wrapper'>
                                <button title='Save' className="SaveIcon" type={'button'} disabled={(CostingViewMode|| isDisable) ? true : false} onClick={() => SaveItem(index)} />
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <div className='action-btn-wrapper'>
                                <button title='Edit' className="Edit" type={'button'} disabled={(CostingViewMode || IsLocked || isDisable) ? true : false} onClick={() => editItem(index)} />
                                <button title='Delete' className="Delete" type={'button'} disabled={(CostingViewMode || IsLocked || isDisable) ? true : false} onClick={() => deleteItem(index, item.OperationId)} />
                              </div>
                            </td>
                          </tr>
                      )
