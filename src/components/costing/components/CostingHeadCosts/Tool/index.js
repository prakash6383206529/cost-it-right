...
import { applicabilityList, IdForMultiTechnology } from '../../../../../config/masterData';
...
function Tool(props) {
  ...
  useEffect(() => {
    dispatch(fetchCostingHeadsAPI('toolcost', false, false, (res) => { setApplicabilityList(res?.data?.SelectList) }))
  }, [])
