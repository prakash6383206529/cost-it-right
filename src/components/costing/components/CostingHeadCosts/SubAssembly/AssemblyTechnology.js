            ...
            if (Object.keys(costData).length > 0) {
                ...
                dispatch(getRMCCTabData(data, false, (res) => {
                    if (res && res.data && res.data.Result && CostingViewMode === false && !IsLockTabInCBCCostingForCustomerRFQ) {
                        ...
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPDomesticCost = Data[0]?.CostingPartDetails?.NetBOPDomesticCost
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPImportCost = Data[0]?.CostingPartDetails?.NetBOPImportCost
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPSourceCost = Data[0]?.CostingPartDetails?.NetBOPSourceCost
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPOutsourcedCost = Data[0]?.CostingPartDetails?.NetBOPOutsourcedCost

                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPDomesticCostWithOutHandlingCharge = Data[0]?.CostingPartDetails?.NetBOPDomesticCostWithOutHandlingCharge
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPImportCostWithOutHandlingCharge = Data[0]?.CostingPartDetails?.NetBOPImportCostWithOutHandlingCharge
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPOutsourcedCostWithOutHandlingCharge = Data[0]?.CostingPartDetails?.NetBOPOutsourcedCostWithOutHandlingCharge
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPSourceCostWithOutHandlingCharge = Data[0]?.CostingPartDetails?.NetBOPSourceCostWithOutHandlingCharge
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBoughtOutPartCostWithOutHandlingCharge = Data[0]?.CostingPartDetails?.NetBoughtOutPartCostWithOutHandlingCharge

                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPDomesticCostWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPDomesticCostWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPImportCostWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPImportCostWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPSourceCostWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPSourceCostWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPOutsourcedCostWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPOutsourcedCostWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBoughtOutPartCostWithQuantity = Data[0]?.CostingPartDetails?.TotalBoughtOutPartCostWithQuantity

                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPDomesticCostWithOutHandlingChargeWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPDomesticCostWithOutHandlingChargeWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPImportCostWithOutHandlingChargeWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPImportCostWithOutHandlingChargeWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPSourceCostWithOutHandlingChargeWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPSourceCostWithOutHandlingChargeWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPOutsourcedCostWithOutHandlingChargeWithQuantity = Data[0]?.CostingPartDetails?.TotalBOPOutsourcedCostWithOutHandlingChargeWithQuantity
                        tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBoughtOutPartCostWithOutHandlingChargeWithQuantity = Data[0]?.CostingPartDetails?.TotalBoughtOutPartCostWithOutHandlingChargeWithQuantity
 ...
 */
    ...
    */
    ...
    const handleBOPCalculationAndClose = (type = '', totalHandlingCharges, tableData, item) => {
    ...
    const setBOPCostWithAsssembly = (obj, item, tableData) => {
        ...
        const bopHandlingCharges = getBOPHandlingCharges();
            ...
            // tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPDomesticCostWithOutHandlingCharge = tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPDomesticCostWithOutHandlingCharge
            // tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPImportCostWithOutHandlingCharge = tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPImportCostWithOutHandlingCharge
            // tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPSourceCostWithOutHandlingCharge = tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPSourceCostWithOutHandlingCharge
            // tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPOutsourcedCostWithOutHandlingCharge = tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPOutsourcedCostWithOutHandlingCharge
            // tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBoughtOutPartCostWithOutHandlingCharge = tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBoughtOutPartCostWithOutHandlingCharge
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPDomesticCost = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPDomesticCostWithOutHandlingCharge + checkForNull(bopHandlingCharges?.domestic)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPImportCost = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPImportCostWithOutHandlingCharge + checkForNull(bopHandlingCharges?.import)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPSourceCost = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPSourceCostWithOutHandlingCharge + checkForNull(bopHandlingCharges?.source)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPOutsourcedCost = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPOutsourcedCostWithOutHandlingCharge + checkForNull(bopHandlingCharges?.outsourced)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBoughtOutPartCost = totalBOPCost 

            // Total costs with quantity (same as Net for assembly level)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPDomesticCostWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPDomesticCost
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPImportCostWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPImportCost
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPSourceCostWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPSourceCost
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPOutsourcedCostWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPOutsourcedCost
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBoughtOutPartCostWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBoughtOutPartCost

            // Total costs without handling charges
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPDomesticCostWithOutHandlingChargeWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPDomesticCostWithOutHandlingCharge
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPImportCostWithOutHandlingChargeWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPImportCostWithOutHandlingCharge
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPSourceCostWithOutHandlingChargeWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPSourceCostWithOutHandlingCharge
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBOPOutsourcedCostWithOutHandlingChargeWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBOPOutsourcedCostWithOutHandlingCharge
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.TotalBoughtOutPartCostWithOutHandlingChargeWithQuantity = tempsubAssemblyTechnologyArray[0].CostingPartDetails?.NetBoughtOutPartCostWithOutHandlingCharge
            ...
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPDomesticHandlingCost = checkForNull(bopHandlingCharges?.domestic)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPImportHandlingCost = checkForNull(bopHandlingCharges?.import)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPSourceHandlingCost = checkForNull(bopHandlingCharges?.source)
            tempsubAssemblyTechnologyArray[0].CostingPartDetails.NetBOPOutsourcedHandlingCost = checkForNull(bopHandlingCharges?.outsourced)
    ...
    useEffect(() => {
        if (subAssemblyTechnologyArray && callSaveAssemblyApi) {
            ...
            let requestData = {
                ...
                "NetProcessCostForRejection": checkForNull(item?.CostingPartDetails?.NetProcessCostForRejection),
                ...
                "NetOperationCostForRejection": checkForNull(item?.CostingPartDetails?.NetOperationCostForRejection),
                ...
                "NetWeldingCostForRejection": checkForNull(item?.CostingPartDetails?.NetWeldingCostForRejection),
                ...
                "NetCCForOtherTechnologyCostForRejection": checkForNull(item?.CostingPartDetails?.NetCCForOtherTechnologyCostForRejection),
                "CostingPartDetails": {
            ...
            item.NetWeldingCost = item?.CostingPartDetails?.NetWeldingCost
