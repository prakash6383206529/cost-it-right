  ...
  */
  const handleZBCSOBChange = (event, index) => {
    ...
    if (!isNaN(event.target.value)) {
      ...
      tempData = { ...tempData, ShareOfBusinessPercent: parseInt(event.target.value), isSOBChanged: checkIsZBCSOBChanged(event, index) }
                                    ...
                                    <tr key={index}>
                                      ...
                                      <td>
                                        <SearchableSelectHookForm
                                          ...
                                          mandatory={false}
                                          handleChange={(newValue) => handleCostingChange(newValue, ZBC, index)}
