  ...
  const setHeaderCostRMCCTab = (data) => {
    if (!CostingViewMode) {
      ...
      tempData = {
        ...
        NetOperationCostForRejection: data?.NetOperationCostForRejection,
        NetProcessCostForRejection: data?.NetProcessCostForRejection,
        NetWeldingCostForRejection: data?.NetWeldingCostForRejection,
        NetCCForOtherTechnologyCostForRejection: data?.NetCCForOtherTechnologyCostForRejection,
