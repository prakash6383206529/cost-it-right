        ...
        <div>
          ...
          <form noValidate className="form" onSubmit={handleSubmit(onSubmit)}>
            <Row className={'mt15'}>
              ...
              <Col md="3">
                <TextFieldHookForm
                  label={`Outer Diameter${Object.keys(UOMDimension).length > 0
                    ? '(' + UOMDimension.label + ')'
                    : ''
                    }`}
                  name={'OuterDiameter'}
              ...
              <Col md="3">
                <TextFieldHookForm
                  label={`Thickness${Object.keys(UOMDimension).length > 0
                    ? '(' + UOMDimension.label + ')'
                    : ''
                    }`}
                  name={'Thickness'}
              ...
              <Col md="3">
                <TextFieldHookForm
                  label={`Inner Diameter${Object.keys(UOMDimension).length > 0
                    ? '(' + UOMDimension.label + ')'
                    : ''
                    }`}
                  name={'InnerDiameter'}
            ...
            <Row>
              <Col md="3">
                <TextFieldHookForm
                  label={`Length of Sheet${Object.keys(UOMDimension).length > 0
                    ? '(' + UOMDimension.label + ')'
                    : ''
                    }`}
                  name={'SheetLength'}
              ...
              <Col md="3">
                <TextFieldHookForm
                  label={`Length of Part${Object.keys(UOMDimension).length > 0
                    ? '(' + UOMDimension.label + ')'
                    : ''
                    }`}
                  name={'PartLength'}
              ...
              <Col md="3">
                <TextFieldHookForm
                  label={`Length of Scrap${Object.keys(UOMDimension).length > 0
                    ? '(' + UOMDimension.label + ')'
                    : ''
                    }`}
                  name={'ScrapLength'}
