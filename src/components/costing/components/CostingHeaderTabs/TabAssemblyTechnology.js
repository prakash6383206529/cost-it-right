  ...
  useEffect(() => {
    ...
    if (CostingViewMode === false) {
      ...
      topHeaderData = {
        ...
        NetWeldingCost: TopHeaderValues?.NetWeldingCost ? TopHeaderValues?.NetWeldingCost : 0,
        NetProcessCostForOverhead: TopHeaderValues?.NetProcessCostForOverhead ? TopHeaderValues?.NetProcessCostForOverhead : 0,
        NetProcessCostForRejection: TopHeaderValues?.NetProcessCostForRejection ? TopHeaderValues?.NetProcessCostForRejection : 0,
        ...
        NetWeldingCostForRejection: TopHeaderValues?.NetWeldingCostForRejection ? TopHeaderValues?.NetWeldingCostForRejection : 0,
        ...
        NetOperationCostForRejection: TopHeaderValues?.NetOperationCostForRejection ? TopHeaderValues?.NetOperationCostForRejection : 0,
        ...
        NetCCForOtherTechnologyCostForRejection: checkForNull(TopHeaderValues?.NetCCForOtherTechnologyCostForRejection)?checkForNull(TopHeaderValues?.NetCCForOtherTechnologyCostForRejection) : 0,
