        ...
        return (
            <div className="container-fluid">
                ...
                <BootstrapTable
                    ...
                    <TableHeaderColumn className="action" dataField="VendorId" searchable={false} export={false} isKey={true} dataFormat={this.buttonFormatter}>Actions</TableHeaderColumn>
                </BootstrapTable>
