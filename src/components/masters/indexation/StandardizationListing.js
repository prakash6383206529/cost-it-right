...
import { deleteCommodityStandardization, getStandardizedCommodityListAPI } from "../actions/Indexation";
...
const StandardizationListing = (props) => {
    ...
    const getTableListData = (skip = 0, take = 10, isPagination = true) => {
        ...
        dispatch(getStandardizedCommodityListAPI(dataObj, isPagination, skip, take, false, (res) => {
...
export default StandardizationListing;
