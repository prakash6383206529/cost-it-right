                      ...
                      <div className="shadow-lgg login-formg">
                        <div className="row">
                          <div className="col-md-6">
                            <h2>
                              {isEditFlag ? `Update Machine` : `Add Machine`}
                            </h2>
                          </div>
                        </div>
                        <form
                          ...
                          <Row>
                            ...
                            <Col md="3">
                              <Field
                                ...
                                disabled={
                                  isEditFlag ||
                                  initialConfiguration.IsMachineNumberConfigure
                                    ? true
                                    : false
                                }
                                className=" "
                                ...
                                <div>
                                  {this.state.IsDetailedEntry
                                    ...
                                    : AddAccessibility && (
                                        ...
                                        >
                                          <div className={"plus"}></div>ADD MORE
                                          DETAILS
                                        </button>
                                      )}
                                </div>
                          ...
                          <Row>
                            ...
                            <Col md="3">
                              ...
                              {this.state.files.length >= 3 ? (
                                <div class="alert alert-danger" role="alert">Max file uploaded.</div>
                              ) : (
                                <Dropzone
