...
class AddMoreDetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isViewFlag: false,
      isDateChange: false,
      selectedTechnology: this.props?.editDetails.selectedTechnology ?? [],
      selectedPlants: {},
      machineType: [],
      ...
      levelDetails: {},
      selectedCustomer: [],
      selectedVedor: this.props?.editDetails.vendorName ?? [],
      costingTypeId: this.props?.editDetails?.costingTypeId,
      CostingTypeId: this.props?.editDetails?.costingTypeId,
      vendorId: null,
      customerId: null,
