                ...
                <div className="ag-grid-wrapper" style={{ width: '100%', height: '100%' }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <AgGridColumn width="100" pinned="right" field="IsActive" floatingFilter={false} headerName="Status" cellRenderer={'statusButtonFormatter'}></AgGridColumn>
                            <AgGridColumn field="PlantId" floatingFilter={false} headerName="Action" type="rightAligned" cellRenderer={'totalValueRenderer'}></AgGridColumn>
                        </AgGridReact>
