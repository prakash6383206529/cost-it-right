...
import { required, number, maxLength6, maxLength80, minLength10, maxLength12, checkWhiteSpaces, acceptAllExceptSingleSpecialCharacter, maxLength15, postiveNumber, maxLength3, checkSpaceForCode } from "../../../helper/validation";
                ...
                <Row className="pl-3">
                  <Col md="6">
                    <Field
                      ...
                      type="text"
                      placeholder={""}
                      validate={[acceptAllExceptSingleSpecialCharacter, checkWhiteSpaces, maxLength15, checkSpaceForCode]}
                      component={renderText}
                      //required={true}
                      className=""
                      customClassName={"withBorder"}
