                      ...
                      <div className="shadow-lgg login-formg">
                        <div className="row">
                          <div className="col-md-6">
                            <h1>{isEditFlag ? `Update Power` : `Add Power`}</h1>
                          </div>
                        </div>
                        <form
                          noValidate
                            ...
                            <>
                              ...
                              <Row>
                                <Col md="12" className="filter-block">
                                  <div className=" flex-fills mb-2 pl-0">
                                    <h5>
                                      {"State Electricity Board Power Charges:"}
                                    </h5>
                                  </div>
                                </Col>
                                <Col md="3">
                                  ...
                                  <div className="d-flex justify-space-between align-items-center inputwith-icon">
                                    <div className="fullinput-icon">
                                      <Field
                                        ...
                                        name={
                                          "MeterRentAndOtherChargesPerAnnum"
                                        }
                                        type="text"
                                        placeholder={"Enter"}
                                        validate={[required]}
                                      ...
                                      <div className="form-group">
                                        ...
                                        <div className="inputbox date-section">
                                          <DatePicker
                                            ...
                                            onChange={
                                              this.handleEffectiveDateChange
                                            }
                                            showMonthDropdown
                                            showYearDropdown
                                  ...
                                  <div className="d-flex justify-space-between align-items-center inputwith-icon">
                                    <div className="fullinput-icon">
                                      <Field
                                        ...
                                        customClassName=" withBorder"
                                        disabled={
                                          this.state.isAddedSEB ? true : false
                                        }
                                      />
                                    </div>
                                  </div>
                                  ...
                                  <div>
                                    {this.state.isEditSEBIndex ? (
                                      ...
                                      <button
                                        ...
                                        onClick={() =>
                                          this.powerSEBTableHandler(false)
                                        }
                                      >
                                  ...
                                  <div>
                                    {this.state.isEditIndex ? (
                                      ...
                                      <button
                                        ...
                                        disabled={
                                          checkPowerContribution ? true : false
                                        }
                                        onClick={() =>
                                          this.powerTableHandler(true)
                                        }
                                      >
                                        <div className={"plus"}></div>ADD
                                      </button>
                                          ...
                                          (item, index) => {
                                            return (
                                              <tr key={index}>
                                                ...
                                                <td>
                                                  {
                                                    item.PowerContributionPercentage
                                                  }
                                                </td>
                                                <td>
                                                  <button
