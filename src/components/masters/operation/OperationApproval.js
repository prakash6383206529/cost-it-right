...
import { defaultPageSize, EMPTY_DATA, OPERATIONS_ID } from '../../../config/constants';
                ...
                <Col md="6" lg="6" className="search-user-block mb-3">
                    <div className="d-flex justify-content-end bd-highlight w100">
                      ...
                      <div className="send-for-approval mr-0" ></div>
                            ...
                            <button title="Send For Approval" class="user-btn approval-btn" disabled={OperationApprovalList && (isFinalApprover || OperationApprovalList.length === 0) ? true : false} onClick={sendForApproval}>
                                <div className="send-for-approval mr-0" ></div>
                            </button>
                        </div>
                    </div>
