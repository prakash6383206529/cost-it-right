...
import { FILE_URL, ZBC, OPERATIONS_ID, EMPTY_GUID, SPACEBAR, searchCount, VBCTypeId, CBCTypeId, ZBCTypeId, VBC_VENDOR_TYPE } from '../../../config/constants';
...
class AddOperation extends Component {
  ...
  */
  renderListing = (label) => {
    const { costingSpecifiTechnology, clientSelectList, plantSelectList, UOMSelectList, } = this.props;
    const temp = [];
    if (label === 'technology') {
