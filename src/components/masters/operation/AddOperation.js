...
import { required, getVendorCode, maxLength80, checkWhiteSpaces, acceptAllExceptSingleSpecialCharacter, maxLength10, maxLength15, positiveAndDecimalNumber, maxLength512, decimalLengthsix, checkSpaceForCode } from "../../../helper/validation";
                    ...
                    <Row>
                      ...
                      <Col md="3">
                        <Field
                          ...
                          type="text"
                          placeholder={"Enter"}
                          validate={[acceptAllExceptSingleSpecialCharacter, maxLength15, checkWhiteSpaces, required, checkSpaceForCode]}
                          component={renderText}
                          required={true}
