        ...
        <Fragment>
            ...
            {states.costingTypeId !== CBCTypeId && <Row className="mb-3 accordian-container">
                ...
                {<Row className={`align-items-center mb-3 ${state.isVendorAccOpen ? '' : 'd-none'}`}>
                    {states.costingTypeId !== CBCTypeId && (<>
                        <Col md="3">
                            <label>{t(states.costingTypeId === ZBCTypeId ? 'RMZeroBasedVendorLabel' : 'RMVendorBasedVendorLabel', { defaultValue: `${vendorLabel}(Code)` })}<span className="asterisk-required">*</span></label>
