                ...
                <Row>
                    <Col>
                        <BootstrapTable
                            ...
                            <TableHeaderColumn width={100} columnTitle={true} dataAlign="left" dataSort={true} searchable={false} dataField="EffectiveDate" dataFormat={this.effectiveDateFormatter} >{this.renderEffectiveDate()}</TableHeaderColumn>
