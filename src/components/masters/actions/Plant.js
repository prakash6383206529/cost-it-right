...
export function getFilteredPlantList(filterData, callback) {
    return (dispatch) => {
        const qParams = `country_id=${filterData.country}&state_id=${filterData.state}&city_id=${filterData.city}&is_vendor=${filterData.is_vendor}&CustomerTypeId=${filterData.CustomerTypeId}`
