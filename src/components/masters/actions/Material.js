...
export function getAllRMDataList(data, skip, take, isPagination, obj, isImport, callback) {
    return (dispatch) => {
        ...
        const queryParams = `technology_id=${data.technologyId}&net_landed_min_range=${data.net_landed_min_range}&net_landed_max_range=${data.net_landed_max_range}&NetCost=${obj.NetLandedCost !== undefined ? obj.NetLandedCost : ""}&ListFor=${data.ListFor ? data.ListFor : ''}&StatusId=${data.StatusId ? data.StatusId : ''}&DepartmentCode=${obj.DepartmentName !== undefined ? obj.DepartmentName : ""}&CustomerName=${obj.CustomerName !== undefined ? obj.CustomerName : ''}&FromDate=${(obj.dateArray && obj.dateArray.length > 1) ? obj.dateArray[0] : ""}&ToDate=${(obj.dateArray && obj.dateArray.length > 1) ? obj.dateArray[1] : ""}&IsCustomerDataShow=${reactLocalStorage.getObject('CostingTypePermission').cbc !== undefined ? reactLocalStorage.getObject('CostingTypePermission').cbc : false}&IsVendorDataShow=${reactLocalStorage.getObject('CostingTypePermission').vbc}&IsZeroDataShow=${reactLocalStorage.getObject('CostingTypePermission').zbc}&ScrapUnitOfMeasurement=${obj.ScrapUnitOfMeasurement !== undefined ? obj.ScrapUnitOfMeasurement : ''}&ScrapRatePerScrapUOM=${obj.ScrapRatePerScrapUOM !== undefined ? obj.ScrapRatePerScrapUOM : ''}&IsScrapUOMApply=${obj.IsScrapUOMApply ? (obj.IsScrapUOMApply?.toLowerCase() === 'yes' ? true : false) : ''}&CalculatedFactor=${obj.CalculatedFactor !== undefined ? obj.CalculatedFactor : ''}&ScrapRatePerScrapUOM=${obj.ScrapRatePerScrapUOM !== undefined ? obj.ScrapRatePerScrapUOM : ''}&UOMToScrapUOMRatio=${obj.UOMToScrapUOMRatio !== undefined ? obj.UOMToScrapUOMRatio : ''}&NetConditionCost=${data.NetConditionCost !== undefined ? data.NetConditionCost : ""}&NetCostWithoutConditionCost=${data.NetCostWithoutConditionCost !== undefined ? data.NetCostWithoutConditionCost : ""}&NetLandedCostConversion=${data.NetLandedCostConversion !== undefined ? data.NetLandedCostConversion : ""}&BasicRatePerUOMConversion=${data.BasicRatePerUOMConversion !== undefined ? data.BasicRatePerUOMConversion : ""}&ScrapRateInINR=${data.ScrapRateInINR !== undefined ? data.ScrapRateInINR : ""}&RawMaterialFreightCostConversion=${data.RawMaterialFreightCostConversion !== undefined ? data.RawMaterialFreightCostConversion : ""}&RawMaterialShearingCostConversion=${data.RawMaterialShearingCostConversion !== undefined ? data.RawMaterialShearingCostConversion : ""}&NetCostWithoutConditionCostConversion=${data.NetCostWithoutConditionCostConversion !== undefined ? data.NetCostWithoutConditionCostConversion : ""}&NetConditionCostConversion=${data.NetConditionCostConversion !== undefined ? data.NetConditionCostConversion : ""}&NetLandedCostConversionAPI=${data.NetLandedCostConversionAPI !== undefined ? data.NetLandedCostConversionAPI : ""}`
