...
export function getRMApprovalList(masterId, skip, take, isPagination, obj, callback) {
    ...
    return (dispatch) => {
        ...
        request.then((response) => {
            ...
            switch (masterId) {
                case 1:
                    data = response.data.Data.RMApprovalList;
                    break;
                case 2:
                    data = response.data.Data.BopApprovalList;
                    break;
                case 3:
                    data = response.data.Data.OperationApprovalList;
                    break;
                case 4:
                    data = response.data.Data.MachineApprovalList;
                    break;
                case 5:
                    data = response.data.Data.BudgetingApprovalList;
                    break;
                default:
