...
export function getOperationsDataList(filterData, skip, take, isPagination, obj, callback) {
    ...
    return (dispatch) => {
        ...
        let payload
        //dispatch({ type: API_REQUEST });
        const QueryParams = `operation_for=${filterData.operation_for}&technology_id=${filterData.technology_id}&DepartmentCode=${obj.DepartmentCode !== undefined ? obj.DepartmentCode : ""}`
