...
import AddAssemblyFormProduct from './AddAssemblyFormProduct';
import AddComponentFormProduct from './AddComponentFormProduct';
import AddBOPFormProduct from './AddBOPFormProduct';

class AddChildDrawerProduct extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isEditFlag: false,
