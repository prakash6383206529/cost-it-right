...
class AddBOPImport extends Component {
  ...
  */
  ...
  componentDidMount() {
    ...
    console.log("getConfigurationKey().bopMaster", getConfigurationKey().BOPMasterName
    )
    const { initialConfiguration } = this.props
                  ...
                  <div className="shadow-lgg login-formg">
                    <div className="row">
                      <div className="col-md-6">
                        <h1>
                          {isViewMode ? "View" : isEditFlag ? "Update" : "Add"} {getConfigurationKey().BOPMasterName} (Import)
                          <TourWrapper
