                            ...
                            <div >
                                <form>
                                    ...
                                    <Row className="part-detail-wrapper">
                                        ...
                                        {technology.label !== "Logistics" && <> <Col md="3">
                                            <SearchableSelectHookForm
                                                label="RM Name"
                                                name={"RMName"}
                                                placeholder={"Select"}
                                                        ...
                                                        <div className={`ag-theme-material `}>
                                                            {!state ? <LoaderCustom customClass={!state ? 'mt-3' : ''} /> :
                                                                ...
                                                                >
                                                                    ...
                                                                    {technology.label !== "Logistics" && <AgGridColumn width={"230px"} field="RMName" headerName="RM Name" cellClass={"colorWhite"}></AgGridColumn>}
                                                                    {console.log('technology.label: ', technology.label)}
                                                                    {technology.label !== "Logistics" && <AgGridColumn width={"230px"} field="RMGrade" headerName="RM Grade" cellClass={"colorWhite"}></AgGridColumn>}
                                                                    {technology.label !== "Logistics" && <AgGridColumn width={"230px"} field="RMSpecification" headerName="RM Specification" cellClass={"colorWhite"}></AgGridColumn>}
